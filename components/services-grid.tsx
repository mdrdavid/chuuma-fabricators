...
const services = [
  {
    title: "Metal Gates",
    description: "Custom metal gates for homes and businesses in Uganda",
    image: "/images/service-gates.jpg",
    href: "/services#gates",
  },
  {
    title: "Security Doors",
    description: "Premium security doors and custom metal designs",
    image: "/images/service-doors.jpg",
    href: "/services#doors",
  },
  {
    title: "Metal Windows",
    description: "Strong window frames and burglar bars for security",
    image: "/images/service-windows.jpg",
    href: "/services#windows",
  },
  {
    title: "Metal Roofing",
    description: "Quality metal roofing solutions for all buildings",
    image: "/images/service-roofing.jpg",
    href: "/services#roofing",
  },
  {
    title: "Railings",
    description: "Elegant metal railings and balcony balustrades",
    image: "/images/service-railings.jpg",
    href: "/services#railings",
  },
  {
    title: "Office Furniture",
    description: "Durable metal office furniture and workstations",
    image: "/images/service-office.jpg",
    href: "/services#office",
  },
  {
    title: "Custom Fabrication",
    description: "Specialized custom metal work for unique projects",
